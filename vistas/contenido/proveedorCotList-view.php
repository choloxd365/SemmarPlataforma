  ...
  <div class="page-content-wrapper-inner">
    <div class="viewport-header">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo SERVERURL ?>proveedorCotList/">COTIZACIONES PENDIENTES</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-lg-12">
          <div class="grid">
            ...
            <div class="item-wrapper" id="tabla">
              ...
              echo $lista->paginador_cotizacion_controlador($pagina[1], 10,"lista","");
              ?>
