  ...
  <div class="page-content-wrapper-inner">
    <div class="viewport-header">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo SERVERURL ?>clienteCotList/"><b>COTIZACIONES PENDIENTES</b></a>
        </li>
        <li class="nav-item">
    ...
    <div class="content-viewport">
      <div class="row">
        <div class="col-lg-12">
          <div class="grid">
            <p class="grid-header">Lista de Cotizaciones</p>
            ...
            <div class="item-wrapper" id="tabla">
              ...
              echo $lista->paginador_cotizacion_cliente_controlador($pagina[1], 10,"Pendiente","");
              ?>
