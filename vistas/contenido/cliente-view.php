    ...
    <div class="viewport-header">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb has-arrow">
          ...
          <li class="breadcrumb-item active" aria-current="page"><b>REGISTRAR CLIENTE</b></li>
        </ol>
      </nav>

      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo SERVERURL ?>cliente/"><b>REGISTRO</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?php echo SERVERURL ?>clienteList/"><b>LISTA</b></a>
        </li>
      </ul>
    </div>
                    ...
                    <div class="col-md-8 mx-auto">
                      ...
                      <div class="form-group row showcase_row_area">
                        <div class="col-md-3 showcase_text_area">
                          <label for="inputType1"><b>Tipo de Persona</label>
                        </div>
                      ...
                      <div class="d-flex justify-content-center">
                        <input type="submit" class="btn btn-outline-primary btn-rounded" value="Registrar Cliente">
            </form>
          </div>
...
<script>
  ...
  function addCancion() {
    ...
    div.innerHTML = '<div id="' + a + '" class="form-group row showcase_row_area"><div class="col-md-3 showcase_text_area"><label for="inputType12">Email ' + a + '</label></div><div class="col-6 showcase_content_area"><input type="email" required="" class="form-control" name="email[]" id="inputType2" placeholder="hayduk@gmail.com"></div><div class="col-3 showcase_content_area"><button class="btn btn-outline-primary btn-rounded mdi mdi-delete" type="button"  onclick="eliminar(' + a + ')"></button></div></div><br>';
